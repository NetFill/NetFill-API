# NetFill Exchange API Documentation
...
The NetFill Exchange API provides developers with direct access to our decentralized exchange infrastructure built on the Solana blockchain. Our API offers the best rates and lowest slippage for token swaps.

**Base URL:** `https://api.netfill.xyz/v1`
...
To get started with the NetFill Exchange API:
...
```bash
curl https://api.netfill.xyz/v1/tokens
```
...
curl -H "Authorization: Bearer YOUR_API_KEY" \
     https://api.netfill.xyz/v1/tokens
```
...
```bash
curl "https://api.netfill.xyz/v1/swap/quote?inputMint=So11111111111111111111111111111111111111112&outputMint=EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v&amount=1000000000&slippageBps=50"
```
...
```bash
curl "https://api.netfill.xyz/v1/price?ids=So11111111111111111111111111111111111111112,EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v"
```
...
**WebSocket URL:** `wss://ws.netfill.xyz`

**JavaScript Example:**

```javascript
const ws = new WebSocket('wss://ws.netfill.xyz');

ws.onopen = () => {
  console.log('Connected to NetFill Exchange');
...
- **Website:** [https://netfill.xyz](https://netfill.xyz)
- **GitHub:** [https://github.com/NetFill/NetFill-API](https://github.com/NetFill/NetFill-API)
- **Twitter:** [https://x.com/NetFillSwap](https://x.com/NetFillSwap)

## Support

For support, questions, or feature requests:

- Open an issue on [GitHub](https://github.com/NetFill/NetFill-API)
- Follow us on [Twitter](https://x.com/NetFillSwap)
- Visit our website at [netfill.xyz](https://netfill.xyz)
